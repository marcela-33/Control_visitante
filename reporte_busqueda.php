    ...
    <div class="row col-12">
        <div class="iconos col-2">
            ...
            <a href="agregar.php" title=" Registrar visitante"><i class="bi bi-journal-check "
                    style="font-size: 3rem; color: black;"></i></a><br><br><br>
        ...
        <div class="col-10">
            ...
            <form class="form-inline" method="get" action="">
                <input type="text" class="form-control" name="busqueda" placeholder="Buscar"/><br>
                <input type="submit" name="enviar" value="Buscar" class="btn btn-primary">
                <a href="reporte_busqueda.php" type="button" class="btn btn-success"><span
